...
class _CommentScreenState extends State<CommentScreen> {
  StreamController<List<CommentModel>> _streamController =
  ...
  Stream<List<CommentModel>> commentsStream() {
    ...
    _streamController.onListen = () {
      ...
      _streamController.add(presetComments);
    };
    ...
    return Padding(
      ...
      child: StreamBuilder(
          ...
          builder: (_, snapshot) {
            ...
            final loadComments = snapshot.data!;
            //TODO Part 2 - Instruction 4
            return commentList(loadComments);
          }),
    );
  }
  ...
  void addComment({
    ...
    _streamController.sink.add(presetComments);
  }
