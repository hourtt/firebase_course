                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: TextButton(
                      onPressed: () {
                        ...
                        _cloudFirestoreHelper.createCommentWithSet(
                          context,
...
class CloudFirestoreHelper {
  ...
  void createCommentWithSet(
    ...
    final reference = db.collection('Posts').doc(postId).collection('Comments').doc();
  ...
  Future<bool> signInEmailAndPassword(
    ...
    try {
      ...
      if (credential.user != null) {
        final response =
            await _firestoreHelper.getOneUser(credential.user!.uid);
