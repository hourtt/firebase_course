  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (_, snapshot) {
        ...
        post = PostModel.fromMap(snapshot.data!.data() as Map<String,dynamic>);
...
class CloudFirestoreHelper {
 ...
 Future <DocumentSnapshot<Map<String,dynamic>>> getOnePosting(String postId) async {
