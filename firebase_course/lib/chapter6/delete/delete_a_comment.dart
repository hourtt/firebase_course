  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => AuthenticationProviders()),
      ],
      child: MaterialApp(
...
class CloudFirestoreHelper {
  ...
  void addComment(
    ...
    final myAccount =
        Provider.of<AuthenticationProviders>(context, listen: false).myAccount!;
    final reference =
...
class CommentScreen extends StatelessWidget {
                  ...
                  return Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Spacer(),
                        Provider.of<AuthenticationProviders>(context,
                                        listen: false)
                                    .myAccount!
                                    .userId ==
                                user.userId
  ...
  Widget commentInputSection(BuildContext context, PostModel model) {
    ...
    return Consumer<AuthenticationProviders>(
  ...
  Widget contentSection(BuildContext context, PostModel model) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Consumer<AuthenticationProviders>(
            builder: (_, provider, __) {
