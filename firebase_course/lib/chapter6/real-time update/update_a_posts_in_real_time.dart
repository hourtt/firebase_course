...
class CloudFirestoreHelper {
  ...
  void updatePosting(BuildContext context, String postId) async {
    ...
    reference.set({
      ...
      'post_img': postingProvider.imageUrl,
    }, SetOptions(merge: true)).whenComplete(() {
      Navigator.pop(context);
    });
  }

  Stream<DocumentSnapshot<Map<String, dynamic>>> getOnePosting(String postId) {
...
class UpdatePostingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<PostingProvider>(context, listen: false)
        .changeImageUrl(model.postImg, description: model.description);
    return Scaffold(
...
class _PostingState extends State<Posting> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      stream: _cloudFirestoreHelper.getOnePosting(widget.postId),
      builder: (_, snapshot) {
...
class PostingProvider with ChangeNotifier {
  ...
  void changeImageUrl(String url, {String? description}) {
    imageUrl = url;
