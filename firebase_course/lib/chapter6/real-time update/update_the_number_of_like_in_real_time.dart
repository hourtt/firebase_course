...
class CloudFirestoreHelper {
  ...
  void likePosting(String userId, String postId, bool isLiked) {
  ...
  Widget contentSection(BuildContext context, PostModel model) {
    return Padding(
      ...
      child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          stream: _cloudFirestoreHelper.getPostStream(model.postId),
              ...
              children: [
                        ...
                        buttons(
                          onTap: () {
                            _cloudFirestoreHelper.likePosting(
                              myAccount.userId,
                              model.postId,
                              post.likeList.contains(myAccount.userId),
                            );
                          },
                          icon: post.likeList.contains(myAccount.userId)
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: post.likeNum == 1 ? 'like' : 'likes',
                        style: TextStyle(
                          fontSize: 14,
