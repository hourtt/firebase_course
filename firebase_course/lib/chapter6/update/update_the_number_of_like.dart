...
class CloudFirestoreHelper {
  ...
  void likePosting(String userId, String postId, bool isLiked) async {
                      ...
                      children: [
                        buttons(
                          onTap: () async {
                            ...
                            _cloudFirestoreHelper.likePosting(
                              user.userId,
                              model.postId,
                              user.likeList.contains(model.postId)
                            );
                            setState((){});
                          },
                          //TODO: Part 2 - Instruction 2
                          icon:user.likeList.contains(model.postId) ? Icons.favorite_outlined : Icons.favorite_border_outlined,
                        ),
                        SizedBox(width: 12),
                        buttons(
                          onTap: () {},
                        ...
                        buttons(
                          onTap: () {
                            _cloudFirestoreHelper.bookmarkPosting(
                                context, model.postId);
                          },
                          icon: user.bookmarkList.contains(model.postId)
                              ? Icons.bookmark
