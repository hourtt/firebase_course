...
class CloudFirestoreHelper {
  ...
  Future<QuerySnapshot<Map<String, dynamic>>> getBookmarkPostings(
      UserModel myAccountInfo) async {
    //TODO: Part 1 - Instruction 2
    return _firestore
        .collection('Posts')
        .where("post_id", whereIn: myAccountInfo.bookmarkList)
        .get();
  }
...
class MyBookmarkPostingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: FutureBuilder(
          future: _cloudFirestoreHelper.getBookmarkPostings(myAccount),
          builder: (_, snapshot) {
