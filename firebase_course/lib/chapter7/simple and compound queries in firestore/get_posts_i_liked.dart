...
class CloudFirestoreHelper {
  ...
  Future<QuerySnapshot<Map<String,dynamic>>> getLikedPostings(UserModel myAccountInfo) async {
    //TODO: Part 1 - Instruction 2
    return _firestore.collection('Posts').where("posts_id",whereIn:myAccountInfo.likeList).get();
  }
...
class MyLikePostingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
      child:FutureBuilder(
        future:_cloudFirestoreHelper.getLikedPostings(
          myAccount
        ),
        builder:(_,snapshot){
