          ...
          child: Column(
            ...
            children: [
              ...
              StreamBuilder(
                ...
                //Set the stream property of the StreamBuilder to the GetFilterMusicDocuments method.\
                //Use it with asStream method below.
                //Stream.asStream() =>cloudFirestoreHelper.getFilteredMusicDocuments(selectedSinger,selectedGenre,selectedSort).asStream(),
...
//TODO: Part 1 - Instruction 1
  //Modify return type of getFilterdMusicDocuments method from void to query snapshot
  ...
  Future<QuerySnapshot<Map<String, dynamic>>> getFilteredMusicDocuments(
    ...
    try {
      ...
      if (selectedGenre.isNotEmpty) {
        ...
        //If selectedGenre is not null, cal the where method with Genre field equal to selected Genre. Then, assign it to the query vairiable
        query = query.where("Genre", isEqualTo: selectedGenre);
      }

      if (selectedSinger.isNotEmpty) {
        //TODO: Part 1 - Instruction 3
        //if selected Singer is not null, call the where method with Singer field equal to selectedSinger. Then, assign it to the query variable
        query = query.where("Singer", isEqualTo: selectedSinger);
      }

      if (selectedSort == "Newest") {
        //TODO: Part 1 - Instruction 4
        //if selectedSort is Newest, call the orderBy method to sort in descending order by the Release_date field. Then, assign it to the query variable
        //if sort is equal to one of thoes value, that mean the sort of that value will be execute
        query = query.orderBy('Release_Date', descending: true);
      }

      if (selectedSort == "Popular") {
        //TODO: Part 1 - Instruction 5
        //if selectedSort is Popular, call the orderBy method to sort in descending order by the Hits field. Then, assign it to the query variable.
        query = query.orderBy('Hits', descending: true);
      }

      //TODO: Part 1 - Instruction 6
      //call the get function with a query variable to retreive data. Then, return it
